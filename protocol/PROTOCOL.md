...
Registry-first Africa-site HIV randomized trials as a transfer template for cheaper and faster RCT delivery.
...
Estimate the proportion of Africa-site HIV randomized trials that meet a pragmatic transfer shortlist defined by smaller enrollment, lower site and country footprint, prospective registration, and completed results posting.
...
Shortlist proportion among Africa-site benchmark trials. In the current analysis this was `18/80` with Wilson 95% interval `0.15` to `0.33`.
...
- Benchmark trials: `80`
- Total enrolled participants across benchmark records: `113972`
- Median trial duration days: `824.5`
- Median results-reporting lag days: `566.5`
- Most represented Africa-site countries: South Africa (41), Uganda (21), Kenya (21), Malawi (9), Zimbabwe (8)
- Shortlist sponsor mix: OTHER (15), NETWORK (2), INDUSTRY (1)
